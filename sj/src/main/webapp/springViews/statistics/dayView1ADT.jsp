...
.div1{ margin:0 auto; width:500px; height:30px} 
 </style>
...
注:1、时间区间在同一天的，将按小时分布来统计<br/>
 ...
 ~<input type="text" name="date2" id="date2" class="tcal" value="" />
   <input type="button" name="sub" onclick="goADT()" value="提交"/>
   <input type="button" name="change" onclick="goUsers()" value="客流量展示"/>
  </div>
<input type="hidden" name="isADT" id="isADT" value="<%=request.getAttribute("isADT")%>"/>
    ...
    function goUsers(){
    	...
    	var isADT=document.getElementById("isADT").value;
