...
//	public static Map<Integer,DicUserMission> userMissionMap=new HashMap<Integer,DicUserMission>();
	...
	// 创建的俱乐部达到白银
	public static final int SILVER_ID = 9;
	// 创建的俱乐部达到黄金
	public static final int GOLD_ID = 9;
	// 创建的俱乐部达到钻石
	public static final int DIAMOND_ID = 9;
	// 创建的俱乐部达到冠军
	public static final int CHAMPION_ID = 9;
	// 单次行程10公里以上时获得100分评分
	public static final int SCORE_ID = 9;
	// 累计里程500公里
	public static final int KM500_ID = 9;
	// 连续5次行程获得100分
	public static final int SCORETIMES5_ID = 9;
