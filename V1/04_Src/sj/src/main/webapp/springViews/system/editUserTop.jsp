...
<html>
	...
	<script type="text/javascript">	
		...
		function doSubmit(obj){
			$("#fm").form('submit',{
				url:"<%=contextPath %>/r/manage/group/<%="updateUser?id=" + id%>",
				onSubmit:function(){
		...
		<div style="width:90%;padding-left:50px;margin-top:50px">
			<table  style="border-collapse: collapse;" width="100%" border="1px" bordercolor="#0eb83a">
				...
				<td align="right"  class="td1" nowrap>
					...
					<td class="td2" nowrap >
						<input id="dept_id"  name="dept_id" class="easyui-combotree" style="width:160px;"  readonly="readonly" data-options="required:true"/>
					</td>
					<td align="right" nowrap class="td1">
						角色名称：
					</td>
					<td class="td2" nowrap>
						<input id="priv_id" name="priv_id" class="easyui-combobox" style="width:160px;"  readonly="readonly" data-options="required:true"/>
					</td>
				</tr>
