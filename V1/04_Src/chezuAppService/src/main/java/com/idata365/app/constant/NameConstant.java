...
public static String getNickName(){
	...
	int i=RandUtils.generateRand(0, size-1);
	int j=RandUtils.generateRand(0, preNicks.length-1);
	return preNicks[j]+"的"+nicks[i];
}
public static void main(String []args){
	for(int i=0;i<100;i++){
	System.out.println(getNickName());
	}
	String aa="31.206863|121.381332";
	int j=aa.indexOf("|");
	System.out.println(aa.substring(0,j));
	System.out.println(aa.substring(j+1,aa.length()));
}
}
