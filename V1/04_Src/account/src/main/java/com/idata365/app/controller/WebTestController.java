...
public class WebTestController   {
    ...
    @RequestMapping(value = "/account/index",method ={RequestMethod.POST,RequestMethod.GET})
    public ModelAndView index(Map<String, Object> model) {
    	model.put("time", DateTools.getCurDate());
		model.put("message", "这是account测试的内容。。。");
    ...
    @RequestMapping(value = "/account/jsp",method ={RequestMethod.POST,RequestMethod.GET})
