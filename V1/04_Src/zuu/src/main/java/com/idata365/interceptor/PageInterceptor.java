package com.idata365.interceptor;
...
import com.idata365.entity.PageParameter;
...
public class PageInterceptor implements Interceptor {
    ...
    private static String defaultPageSqlId = ".*Page.*"; // 需要拦截的ID(正则匹配) 以Page结尾的正则表达式
        ...
        if (mappedStatement.getId().matches(pageSqlId)) {
            ...
            if (parameterObject == null) {
                ...
                PageParameter page = (PageParameter) metaStatementHandler
                        .getValue("delegate.boundSql.parameterObject.pageObject");
