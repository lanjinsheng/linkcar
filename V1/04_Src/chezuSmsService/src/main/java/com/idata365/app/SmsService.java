...
public class SmsService {
	 ...
	 * System.out.println("Message=" + querySendDetailsResponse.getMessage()); int i
	 * = 0; for(QuerySendDetailsResponse.SmsSendDetailDTO smsSendDetailDTO :
	 * querySendDetailsResponse.getSmsSendDetailDTOs()) {
	 * System.out.println("SmsSendDetailDTO["+i+"]:"); System.out.println("Content="
	 * + smsSendDetailDTO.getContent()); System.out.println("ErrCode=" +
	 * smsSendDetailDTO.getErrCode()); System.out.println("OutId=" +
	 * smsSendDetailDTO.getOutId()); System.out.println("PhoneNum=" +
	 * smsSendDetailDTO.getPhoneNum()); System.out.println("ReceiveDate=" +
	 ...
	 * smsSendDetailDTO.getTemplateCode()); } System.out.println("TotalCount=" +
	 * querySendDetailsResponse.getTotalCount()); System.out.println("RequestId=" +
